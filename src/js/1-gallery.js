...
const createGalleryItem = ({preview, original, description}) =>
  `<li class="gallery-item">
	<a class="gallery-link gallery-link-js" href="${original}">
		<img
		  class="gallery-image"
		  src="${preview}"
		  alt="${description}"
